/*
  # Create Cached Crypto Pairs Table and Function

  1. New Table
    - `cached_crypto_pairs` - Stores cached crypto trading pairs from CoinGecko
    
  2. New Function
    - `create_cached_crypto_pairs_table_if_not_exists` - Creates the table if it doesn't exist
    
  3. Security
    - Enable RLS on the new table
    - Add policies for authenticated users to read cached data
    - Add policy for service role to manage the cache
*/
