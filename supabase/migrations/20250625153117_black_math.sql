/*
  # Fix Futures Order Triggering

  1. Problem Fixed
    - Orders not triggering when price conditions are met
    - Limit buy orders not executing when price drops below limit price
    
  2. Solution
    - Improve the process_futures_orders function to use the latest market data
    - Ensure proper price comparison for limit orders
    - Fix the subquery that retrieves current market prices
*/
