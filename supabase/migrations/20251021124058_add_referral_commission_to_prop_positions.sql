/*
  # Add Referral Commission to Prop Position Closing

  1. Function Updates
    - Update close_prop_position to call process_referral_commission
    - Process referral commission when prop positions close with profit
    
  2. Changes
    - Call process_referral_commission after closing prop position
    - Only process if PnL is positive (winning position)
    - Pass position details to referral commission function
*/

-- Update close_prop_position to include referral commission processing
