...
DROP POLICY IF EXISTS "Users can manage own assets" ON user_assets;
DROP POLICY IF EXISTS "Service role can manage all assets" ON user_assets;
...
-- Drop existing trigger before creating it to avoid conflicts
